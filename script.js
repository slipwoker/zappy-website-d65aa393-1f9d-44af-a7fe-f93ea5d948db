document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    simulateFormSubmission(form)
      ...
      .catch(function () {
        showFormError(form, 'Something went wrong. Please try again later.');
      })
      .finally(function () {
        if (submitBtn) {
  ...
  function clearFormErrors(form) {
    ...
    const existingMessages = form.querySelectorAll('.form-success-banner, .form-error-banner');
  ...
  // Auto-detect and animate generic sections if no explicit animate classes exist
  if (animatableElements.length === 0) {
    ...
    if (autoElements.length > 0 && 'IntersectionObserver' in window) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'd65aa393-1f9d-44af-a7fe-f93ea5d948db',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'd65aa393-1f9d-44af-a7fe-f93ea5d948db';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd65aa393-1f9d-44af-a7fe-f93ea5d948db';
